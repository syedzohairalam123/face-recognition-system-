...
def utcnow():
    ...
    SQLite does not store timezone info, so all datetimes in the DB must be naive.
    This replaces the deprecated datetime.utcnow() while keeping naive-Datetime
    semantics for the rest of the codebase.
    """
